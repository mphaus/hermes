...
>
    ...
    @if (request()->routeIs('users.create'))
        <p class="text-sm">{{ __('The user will be emailed with the subject \'Welcome to MPH Hermes, your new account is ready\' with a prompt to set their password. Users can reset their password at any time.') }}</p>    
    @endif
</x-form>
