...
$classes = ($active ?? false)
            ? 'block w-full ps-3 pe-4 py-2 border-l-4 border-primary-500 text-start text-base font-medium text-primary-500 bg-primary-100 focus:outline-hidden focus:text-primary-600 focus:bg-primary-100 focus:border-primary-600 transition duration-150 ease-in-out'
