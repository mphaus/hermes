<x-layout-app>
    <x-slot:title>{{ __('Quaratine Intake Success') }}</x-slot:title>
    <x-slot:heading>{{ __('Success!') }}</x-slot:heading>
    <div class="mx-auto xl:grid xl:gap-4 xl:grid-cols-7 max-w-(--breakpoint-2xl)">
