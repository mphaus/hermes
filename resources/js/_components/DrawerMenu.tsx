        ...
        <ul className="p-4 menu bg-base-100 flex-1 sm:w-80 w-64">
            ...
            <li>
                <details className="collapse">
                    <summary className="flex items-center justify-between p-3 font-semibold collapse-title text-primary">{'Discussions'}</summary>
            ...
            <li>
                <details className="collapse">
                    <summary className="flex items-center justify-between p-3 font-semibold collapse-title text-primary">{'Role CRUD'}</summary>
                    <div className="collapse-content">
                        <ul>
                            <li>
